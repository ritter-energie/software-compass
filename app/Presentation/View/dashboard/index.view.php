...
<x-layout>
    ...
    <section class="two-column">
        <div class="panel">
            ...
            <table><thead><tr><th><?= htmlspecialchars(\App\Shared\Support\Translator::translate('table.name')) ?></th><th><?= htmlspecialchars(\App\Shared\Support\Translator::translate(
                'table.purpose',
            )) ?></th></tr></thead><tbody>
        ...
        <div class="panel">
            ...
            <table><thead><tr><th><?= htmlspecialchars(\App\Shared\Support\Translator::translate('table.component')) ?></th><th><?= htmlspecialchars(\App\Shared\Support\Translator::translate(
                'table.status',
            )) ?></th></tr></thead><tbody>
            <?php foreach ($dashboard->openReviews as $review): ?>
                <tr><td><a href="/components/<?= $review['component_id'] ?>">C<?= (int) $review['component_id'] ?></a></td><td><?= htmlspecialchars(\App\Shared\Support\GovernanceStatusLabel::from(
        ...
        <div class="panel">
            ...
            <?php foreach ($dashboard->incompleteComponents as $component): ?>
                <tr><td><a href="/components/<?= $component['id'] ?>"><?= htmlspecialchars($component['name']) ?></a></td><td><span class="badge badge-warning"><?= htmlspecialchars(\App\Shared\Support\Translator::translate(
                    'common.needs_documentation',
                )) ?></span></td></tr>
            <?php endforeach; ?>
        ...
        <div class="panel">
            ...
            <?php foreach ($dashboard->criticalDependencies as $dependency): ?>
                <tr><td><a href="/dependencies/<?= $dependency['id'] ?>"><?= htmlspecialchars($dependency['name']) ?></a></td><td><?= htmlspecialchars(
                    (string) $dependency['data_description'],
                ) ?></td></tr>
            <?php endforeach; ?>
