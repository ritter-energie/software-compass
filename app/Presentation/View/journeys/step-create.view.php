...
<x-layout>
    ...
    <form method="POST" action="/journeys/<?= $journeyId ?>/steps">
        ...
        <div class="actions"><button type="submit" class="button-primary"><?= htmlspecialchars(\App\Shared\Support\Translator::translate('journeys.add_step')) ?></button><a class="button-secondary" href="/journeys/<?= $journeyId ?>"><?= htmlspecialchars(\App\Shared\Support\Translator::translate('common.cancel')) ?></a></div>
    </form>
</x-layout>
