...
<x-layout>
    ...
    <form method="POST" action="/journeys/<?= $journey->id() ?>">
        ...
        <div class="form-actions actions"><button class="button-primary" type="submit"><?= htmlspecialchars(\App\Shared\Support\Translator::translate('common.save_changes')) ?></button><a class="button-secondary" href="/journeys/<?= $journey->id() ?>"><?= htmlspecialchars(\App\Shared\Support\Translator::translate('common.cancel')) ?></a></div>
    </form>
