...
<x-layout>
    ...
    <form method="POST" action="/journey-steps/<?= $step->id() ?>">
        ...
        <div class="actions"><button type="submit" class="button-primary"><?= htmlspecialchars(\App\Shared\Support\Translator::translate('journeys.save_step')) ?></button><a class="button-secondary" href="/journeys/<?= $step->journeyId() ?>"><?= htmlspecialchars(\App\Shared\Support\Translator::translate(
            'common.cancel',
        )) ?></a></div>
    </form>
</x-layout>
