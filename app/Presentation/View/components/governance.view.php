    ...
    <?php else: ?>
        <form method="POST" action="/governance/reviews/<?= $review->id() ?>">
            ...
            <div class="form-actions">
                ...
                <button type="submit" formaction="/governance/reviews/<?= $review->id() ?>/approve" class="button-primary"><?= htmlspecialchars(\App\Shared\Support\Translator::translate(
                    'governance.approve',
                )) ?></button>
                <button type="submit" formaction="/governance/reviews/<?= $review->id() ?>/reject" class="button-danger"><?= htmlspecialchars(\App\Shared\Support\Translator::translate(
                    'governance.reject',
                )) ?></button>
            </div>
        </form>
